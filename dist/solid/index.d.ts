...
declare const getRouter: (atom: keyof typeof listAtom) => Accessor<string>;
...
export { ACTIVE_APP, ACTIVE_MODAL, ACTIVE_NOTIFY, ACTIVE_PANEL, ACTIVE_PARAMS, ACTIVE_POPOUT, ACTIVE_VIEW, Router, backPage, callback, getNotify, getParams, getRouter, hideNotify, nextPage, showNotify, swapApp };
